...
===============================================================================
                       Date Generated       : 10/17/2025 2:10:37 PM
===============================================================================
*/
...
namespace Temiang.Avicenna.BusinessObject
{
	...
	abstract public class esItemPackage : esEntityWAuditLog
	{
		...
		/// <summary>
		/// Maps to ItemPackage.QtyDosage
		/// </summary>
		virtual public System.Decimal? QtyDosage
		{
			get
			{
				return base.GetSystemDecimal(ItemPackageMetadata.ColumnNames.QtyDosage);
			}

			set
			{
				base.SetSystemDecimal(ItemPackageMetadata.ColumnNames.QtyDosage, value);
			}
		}
		/// <summary>
		/// Maps to ItemPackage.SRDosageUnit
		/// </summary>
		virtual public System.String SRDosageUnit
		{
			get
			{
				return base.GetSystemString(ItemPackageMetadata.ColumnNames.SRDosageUnit);
			}

			set
			{
				base.SetSystemString(ItemPackageMetadata.ColumnNames.SRDosageUnit, value);
			}
		}
	...
	abstract public class esItemPackageQuery : esDynamicQuery
	{
		...
		public esQueryItem QtyDosage
		{
			get
			{
				return new esQueryItem(this, ItemPackageMetadata.ColumnNames.QtyDosage, esSystemType.Decimal);
			}
		}
		...
		public esQueryItem SRDosageUnit
		{
			get
			{
				return new esQueryItem(this, ItemPackageMetadata.ColumnNames.SRDosageUnit, esSystemType.String);
			}
		}
	...
	public partial class ItemPackageMetadata : esMetadata, IMetadata
	{
		...
		protected ItemPackageMetadata()
		{
			...
			c = new esColumnMetadata(ItemPackageMetadata.ColumnNames.QtyDosage, 13, typeof(System.Decimal), esSystemType.Decimal);
			c.PropertyName = ItemPackageMetadata.PropertyNames.QtyDosage;
			c.NumericPrecision = 10;
			c.NumericScale = 2;
			c.IsNullable = true;
			_columns.Add(c);

			c = new esColumnMetadata(ItemPackageMetadata.ColumnNames.SRDosageUnit, 14, typeof(System.String), esSystemType.String);
			c.PropertyName = ItemPackageMetadata.PropertyNames.SRDosageUnit;
			c.CharacterMaxLength = 20;
			c.IsNullable = true;
			_columns.Add(c);
