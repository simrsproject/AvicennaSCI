...
===============================================================================
                       Date Generated       : 9/26/2024 11:06:18 AM
===============================================================================
*/
...
namespace Temiang.Avicenna.BusinessObject
{
    ...
    abstract public class esReferExternal : esEntityWAuditLog
    {
            ...
            if (col != null)
            {
                if (value == null || value is System.String)
                {
                    ...
                    switch (name)
                    {
                        ...
                        case "SRReferType": this.str.SRReferType = (string)value; break;
                    }
                }
                else
                {
        ...
        /// <summary>
        /// Maps to ReferExternal.SRReferType
        /// </summary>
        virtual public System.String SRReferType
        {
            get
            {
                return base.GetSystemString(ReferExternalMetadata.ColumnNames.SRReferType);
            }

            set
            {
                base.SetSystemString(ReferExternalMetadata.ColumnNames.SRReferType, value);
            }
        }
        ...
        sealed public class esStrings
        {
            ...
            public System.String SRReferType
            {
                get
                {
                    System.String data = entity.SRReferType;
                    return (data == null) ? String.Empty : Convert.ToString(data);
                }

                set
                {
                    if (value == null || value.Length == 0) entity.SRReferType = null;
                    else entity.SRReferType = Convert.ToString(value);
                }
            }
    ...
    abstract public class esReferExternalQuery : esDynamicQuery
    {
        ...
        public esQueryItem SRReferType
        {
            get
            {
                return new esQueryItem(this, ReferExternalMetadata.ColumnNames.SRReferType, esSystemType.String);
            }
        }
    ...
    public partial class ReferExternalMetadata : esMetadata, IMetadata
    {
        ...
        protected ReferExternalMetadata()
        {
            ...
            c = new esColumnMetadata(ReferExternalMetadata.ColumnNames.SRReferType, 13, typeof(System.String), esSystemType.String);
            c.PropertyName = ReferExternalMetadata.PropertyNames.SRReferType;
            c.CharacterMaxLength = 15;
            c.IsNullable = true;
            _columns.Add(c);
        ...
        public class ColumnNames
        {
            ...
            public const string SRReferType = "SRReferType";
        }
        #endregion
        ...
        private esProviderSpecificMetadata esDefault(string mapName)
        {
            if (!_providerMetadataMaps.ContainsKey(mapName))
            {
                ...
                meta.AddTypeMap("SRReferType", new esTypeMap("varchar", "System.String"));
