...
===============================================================================
                       Date Generated       : 05/11/2025 15:49:41
===============================================================================
*/
...
namespace Temiang.Avicenna.BusinessObject
{
    ...
    abstract public class esItemProductMedic : esEntityWAuditLog
    {
            ...
            if (col != null)
            {
                if (value == null || value is System.String)
                {
                    ...
                    switch (name)
                    {
                        ...
                        case "SRCvxName": this.str.SRCvxName = (string)value; break;
                    }
                }
                else
                {
        ...
        /// <summary>
        /// Maps to ItemProductMedic.IsVaccine
        /// </summary>
        virtual public System.Boolean? IsVaccine
        {
            get
            {
                return base.GetSystemBoolean(ItemProductMedicMetadata.ColumnNames.IsVaccine);
            }

            set
            {
                base.SetSystemBoolean(ItemProductMedicMetadata.ColumnNames.IsVaccine, value);
            }
        }
        /// <summary>
        /// Maps to ItemProductMedic.SRCvxName
        /// </summary>
        virtual public System.String SRCvxName
        {
            get
            {
                return base.GetSystemString(ItemProductMedicMetadata.ColumnNames.SRCvxName);
            }

            set
            {
                base.SetSystemString(ItemProductMedicMetadata.ColumnNames.SRCvxName, value);
            }
        }
        ...
        sealed public class esStrings
        {
            ...
            public System.String SRCvxName
            {
                get
                {
                    System.String data = entity.SRCvxName;
                    return (data == null) ? String.Empty : Convert.ToString(data);
                }

                set
                {
                    if (value == null || value.Length == 0) entity.SRCvxName = null;
                    else entity.SRCvxName = Convert.ToString(value);
                }
            }
    ...
    abstract public class esItemProductMedicQuery : esDynamicQuery
    {
        ...
        public esQueryItem IsVaccine
        {
            get
            {
                return new esQueryItem(this, ItemProductMedicMetadata.ColumnNames.IsVaccine, esSystemType.Boolean);
            }
        }

        public esQueryItem SRCvxName
        {
            get
            {
                return new esQueryItem(this, ItemProductMedicMetadata.ColumnNames.SRCvxName, esSystemType.String);
            }
        }
    ...
    public partial class ItemProductMedicMetadata : esMetadata, IMetadata
    {
        ...
        protected ItemProductMedicMetadata()
        {
            ...
            c = new esColumnMetadata(ItemProductMedicMetadata.ColumnNames.SRRoute, 69, typeof(System.String), esSystemType.String);
            c.PropertyName = ItemProductMedicMetadata.PropertyNames.SRRoute;
            c.CharacterMaxLength = 20;
            c.IsNullable = true;
            _columns.Add(c);

            c = new esColumnMetadata(ItemProductMedicMetadata.ColumnNames.IsAso, 70, typeof(System.Boolean), esSystemType.Boolean);
            ...
            c = new esColumnMetadata(ItemProductMedicMetadata.ColumnNames.IsVaccine, 81, typeof(System.Boolean), esSystemType.Boolean);
            c.PropertyName = ItemProductMedicMetadata.PropertyNames.IsVaccine;
            c.IsNullable = true;
            _columns.Add(c);

            c = new esColumnMetadata(ItemProductMedicMetadata.ColumnNames.SRCvxName, 82, typeof(System.String), esSystemType.String);
            c.PropertyName = ItemProductMedicMetadata.PropertyNames.SRCvxName;
        ...
        public class ColumnNames
        {
            ...
            public const string SRCvxName = "SRCvxName";
        }
        #endregion
        ...
        private esProviderSpecificMetadata esDefault(string mapName)
        {
            if (!_providerMetadataMaps.ContainsKey(mapName))
            {
                ...
                meta.AddTypeMap("SRCvxName", new esTypeMap("varchar", "System.String"));
