...
===============================================================================
                       Date Generated       : 1/29/2026 1:51:27 PM
===============================================================================
*/
...
namespace Temiang.Avicenna.BusinessObject
{
    ...
    abstract public class esItemTransaction : esEntityWAuditLog
    {
            ...
            if (col != null)
            {
                if (value == null || value is System.String)
                {
                    ...
                    switch (name)
                    {
                        ...
                        case "IsNewTaxCalculation": this.str.IsNewTaxCalculation = (string)value; break;
                    }
                }
                else
                {
                    switch (name)
                    {
                        ...
                        case "SalesMarginPercentage":
                            ...
                            break;
                        case "IsNewTaxCalculation":

                            if (value == null || value is System.Boolean)
                                this.IsNewTaxCalculation = (System.Boolean?)value;
                            break;
        ...
        /// <summary>
        /// Maps to ItemTransaction.IsNewTaxCalculation
        /// </summary>
        virtual public System.Boolean? IsNewTaxCalculation
        {
            get
            {
                return base.GetSystemBoolean(ItemTransactionMetadata.ColumnNames.IsNewTaxCalculation);
            }

            set
            {
                base.SetSystemBoolean(ItemTransactionMetadata.ColumnNames.IsNewTaxCalculation, value);
            }
        }
        ...
        sealed public class esStrings
        {
            ...
            public System.String IsNewTaxCalculation
            {
                get
                {
                    System.Boolean? data = entity.IsNewTaxCalculation;
                    return (data == null) ? String.Empty : Convert.ToString(data);
                }

                set
                {
                    if (value == null || value.Length == 0) entity.IsNewTaxCalculation = null;
                    else entity.IsNewTaxCalculation = Convert.ToBoolean(value);
                }
            }
    ...
    abstract public class esItemTransactionQuery : esDynamicQuery
    {
        ...
        public esQueryItem IsNewTaxCalculation
        {
            get
            {
                return new esQueryItem(this, ItemTransactionMetadata.ColumnNames.IsNewTaxCalculation, esSystemType.Boolean);
            }
        }
    ...
    public partial class ItemTransactionMetadata : esMetadata, IMetadata
    {
        ...
        protected ItemTransactionMetadata()
        {
            ...
            c = new esColumnMetadata(ItemTransactionMetadata.ColumnNames.IsNewTaxCalculation, 87, typeof(System.Boolean), esSystemType.Boolean);
            c.PropertyName = ItemTransactionMetadata.PropertyNames.IsNewTaxCalculation;
            c.IsNullable = true;
            _columns.Add(c);
        ...
        public class ColumnNames
        {
            ...
            public const string IsNewTaxCalculation = "IsNewTaxCalculation";
        }
        #endregion
        ...
        private esProviderSpecificMetadata esDefault(string mapName)
        {
            if (!_providerMetadataMaps.ContainsKey(mapName))
            {
                ...
                meta.AddTypeMap("IsNewTaxCalculation", new esTypeMap("bit", "System.Boolean"));
