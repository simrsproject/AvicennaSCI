...
namespace Temiang.Avicenna.BusinessObject
{
    ...
    abstract public class esBed : esEntityWAuditLog
    {
        ...
        /// </summary>
        virtual public System.String OldBedID
        {
            get
            {
                return base.GetSystemString(BedMetadata.ColumnNames.OldBedID);
            }
        ...
        sealed public class esStrings
        {
            ...
            public System.String OldBedID
            {
                get
                {
                    System.String data = entity.OldBedID;
                    return (data == null) ? String.Empty : Convert.ToString(data);
                }

                set
                {
                    if (value == null || value.Length == 0) entity.OldBedID = null;
    ...
    abstract public class esBedQuery : esDynamicQuery
    {
        ...
        public esQueryItem OldBedID
        {
            get
            {
                return new esQueryItem(this, BedMetadata.ColumnNames.OldBedID, esSystemType.String);
            }
        }
    ...
    public partial class BedMetadata : esMetadata, IMetadata
    {
        ...
        protected BedMetadata()
        {
            ...
            c = new esColumnMetadata(BedMetadata.ColumnNames.OldBedID, 14, typeof(System.String), esSystemType.String);
            c.PropertyName = BedMetadata.PropertyNames.OldBedID;
            c.CharacterMaxLength = 10;
            c.IsNullable = true;
            _columns.Add(c);

            c = new esColumnMetadata(BedMetadata.ColumnNames.DefaultChargeClassID, 15, typeof(System.String), esSystemType.String);
            c.PropertyName = BedMetadata.PropertyNames.DefaultChargeClassID;
            c.CharacterMaxLength = 10;
            c.IsNullable = true;
            _columns.Add(c);

            c = new esColumnMetadata(BedMetadata.ColumnNames.Notes, 16, typeof(System.String), esSystemType.String);
